...
'''
This program finds the urls for the mentioned tag and downloads them into local disc'
'''
...
#flickr api allows only to obtain 4K image urls at once, that's why we need to change the timing of images to obtain more photos
