...
path = r'C:\Users\Administrator\Desktop\az\poi_dataset_1K+\train' 

X_train, X_test, Y_train, Y_test = preprocessing(224, 224, path)
...
hist = model.fit(X_train, Y_train, batch_size=16, epochs=30, verbose=1, validation_data=(X_test, Y_test),callbacks=callbacks_list)
#%%
...
test_image = X_test[1229:1230]

print(model.predict(test_image))
#print(model.predict_classes(test_image))
print(Y_test[1229:1230])
...
#print(y_pred)
target_names =  ['c00_neuschwanstein', 'c01_cologne cathedral', 'c02_brandenburger tor','c03_heidelberg castle', 
                'c04_marienplatz', 'c05_frauenkirche', 'c06_berlin wall', 'c07_reichstag',
                'c08_nymphenburg', 'c09_speicherstadt', 'c10_oktoberfest', 'c11_christkindlmarkt' ]
...
plot_confusion_matrix(cnf_matrix, classes=target_names, normalize=True,
                      title='Confusion matrix')
plt.savefig('resnet50_confusion_matrix.png', format='png')
