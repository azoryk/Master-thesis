...
url = 'http://res.muenchen-p.de/fl_progressive,q_65/.imaging/stk/responsive/teaser300/dms/va-2016/oktoberfest-2016/anstich-2016/anstich-2016-reiter-hp/document/anstich-2016-reiter-hp.jpg'
...
print('Test image belongs to: class 0' + str(max_ind) + ' "' + str(poi_list[max_ind][4:]) + '" with the acccuracy: ' + str(max_val) )		
...
target_names = ['class 0(neuschwanstein)', 'class 1(cologne cathedral)', 'class 2(brandenburger tor)','class 3(heidelberg castle)', 
                ...
                'class 8(nymphenburg)', 'class 9(speicherstadt)', 'class 10(oktoberfest)', 'class 11(christkindlmarkt)' ]
